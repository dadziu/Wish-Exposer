...
import pl.dawid.wishexposer.domain.UserPrincipal;
import pl.dawid.wishexposer.enumeration.Role;
...
import pl.dawid.wishexposer.service.LoginAttemptService;
import pl.dawid.wishexposer.service.UserService;
...
import static pl.dawid.wishexposer.constant.FileConstant.*;
import static pl.dawid.wishexposer.constant.UserImplConstant.*;
import static pl.dawid.wishexposer.enumeration.Role.ROLE_USER;
...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    @Override
    public User register(String firstName, String lastName, String username, String email) throws UserNotFoundException, UsernameExistException, EmailExistException, MessagingException, UnsupportedEncodingException {
        ...
        String emailMessage = "Hello " + firstName + ", \n \n Your new account password is: " + password + "\n \n The support Team";
        emailService.sendNewEmail(new Email(email, EMAIL_SUBJECT, emailMessage));
        return user;
    }
    ...
    @Override
    public void resetPassword(String email) throws MessagingException, EmailNotFoundException, UnsupportedEncodingException {
        ...
        userRepository.save(user);
        LOGGER.info("New user password: " + password);
        String emailMessage = "Hello " + user.getFirstName() + ", \n \n Your new account password is: " + password + "\n \n The support Team";
        emailService.sendNewEmail(new Email(user.getEmail(), EMAIL_SUBJECT, emailMessage));
    }
    ...
    private void saveProfileImage(User user, MultipartFile profileImage) throws IOException, NotAnImageFileException {
        if (profileImage != null) { // user/home/wish-exposer/user/rick"
    ...
    private Role getRoleEnumName(String role) { //"user"
